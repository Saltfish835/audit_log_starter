...
public class AuditLogAnnotationInterceptor implements MethodInterceptor {
    ...
    public AuditLogAnnotationInterceptor(BeanFactory beanFactory, AuditLogProperties properties, AsyncHttpClient asyncHttpClient) {
    ...
    public Object invoke(MethodInvocation invocation) throws Throwable {
        ...
        SendAuditLogHandler sendAuditLogHandler = new SendAuditLogHandler(properties, asyncHttpClient);
        try{
            // 调用被代理类的方法
